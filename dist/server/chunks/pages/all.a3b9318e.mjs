/* empty css                           */import { c as createAstro, a as createComponent$1, r as renderTemplate, b as addAttribute, d as renderHead, e as renderSlot, m as maybeRenderHead, f as renderComponent, _ as __astro_tag_component__ } from '../astro.5640ca73.mjs';
import 'html-escaper';
/* empty css                           */import { useClipboard, useEventListener, useThrottleFn } from 'solidjs-use';
import MarkdownIt from 'markdown-it';
import mdKatex from 'markdown-it-katex';
import mdHighlight from 'markdown-it-highlightjs';
/* empty css                              */import { fetch as fetch$1 } from 'undici';
...
const $$Layout = createComponent$1(async ($$result, $$props, $$slots) => {
  ...
  <head>
    ...
    ${null}
    ${renderTemplate(_a || (_a = __template(['<script src="/registerSW.js"><\/script><link rel="manifest" href="/manifest.webmanifest">'])))}
${renderHead($$result)}</head><nav>
  <ul>
    <li><a href="#">Beranda</a></li>
    <li><a href="http://baak.gunadarma.ac.id/">Tentang Kami</a></li>
...
}, "C:/Users/mahes/OneDrive - riverz/Desktop/mahesachatgptweb/src/layouts/Layout.astro");
...
}, "C:/Users/mahes/OneDrive - riverz/Desktop/mahesachatgptweb/src/components/Logo.astro");
...
}, "C:/Users/mahes/OneDrive - riverz/Desktop/mahesachatgptweb/src/components/Themetoggle.astro");
...
const $$Header = createComponent$1(async ($$result, $$props, $$slots) => {
  ...
  <div class="fi mt-2">
    <span class="gpt-title">Mahes</span>
    <span class="gpt-subtitle">-AI</span>
  </div>
  <p mt-1 op-60>MahesAI Adalah Teknologi Kecerdasan Buatan (AI).</p>
</header>`;
}, "C:/Users/mahes/OneDrive - riverz/Desktop/mahesachatgptweb/src/components/Header.astro");
...
const $$Footer = createComponent$1(async ($$result, $$props, $$slots) => {
  ...
  <p mt-8 text-xs op-30>
    <span pr-1>Mahes-AI</span>
    <span px-1>| 2023</span>
  </p>
</footer>`;
}, "C:/Users/mahes/OneDrive - riverz/Desktop/mahesachatgptweb/src/components/Footer.astro");
...
const _tmpl$$7 = ["<svg", " xmlns=\"http://www.w3.org/2000/svg\" width=\"1em\" height=\"1em\" viewBox=\"0 0 24 24\"><path fill=\"currentColor\" d=\"M8 20v-5h2v5h9v-7H5v7h3zm-4-9h16V8h-6V4h-4v4H4v3zM3 21v-8H2V7a1 1 0 0 1 1-1h5V3a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v3h5a1 1 0 0 1 1 1v6h-1v8a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1z\"></path></svg>"];
...
const _tmpl$$5 = ["<div", " class=\"py-2 -mx-4 px-4 transition-colors md:hover:bg-slate/3\"><div class=\"", "\"><div class=\"", "\"></div><div class=\"message prose break-words overflow-hidden\">", "</div></div><!--#-->", "<!--/--></div>"],
  _tmpl$2$3 = ["<div", " class=\"fie px-3 mb-2\"><div class=\"gpt-retry-btn\"><!--#-->", "<!--/--><span>Perbarui</span></div></div>"];
const _arrow_function$5 = ({
  ...
  return ssr(_tmpl$$5, ssrHydrationKey(), `flex gap-3 rounded-lg ${role === "user" ? "op-75" : ""}`, `shrink-0 w-7 h-7 mt-4 rounded-full op-80 ${escape(roleClass[role], true)}`, htmlString(), showRetry?.() && onRetry && ssr(_tmpl$2$3, ssrHydrationKey(), escape(createComponent(_arrow_function$6, {}))));
};

__astro_tag_component__(_arrow_function$5, "@astrojs/solid-js");

const _tmpl$$4 = ["<svg", " xmlns=\"http://www.w3.org/2000/svg\" width=\"1rem\" height=\"1rem\" viewBox=\"0 0 32 32\"><path fill=\"currentColor\" d=\"M30 15h-2.05A12.007 12.007 0 0 0 17 4.05V2h-2v2.05A12.007 12.007 0 0 0 4.05 15H2v2h2.05A12.007 12.007 0 0 0 15 27.95V30h2v-2.05A12.007 12.007 0 0 0 27.95 17H30ZM17 25.95V22h-2v3.95A10.017 10.017 0 0 1 6.05 17H10v-2H6.05A10.017 10.017 0 0 1 15 6.05V10h2V6.05A10.017 10.017 0 0 1 25.95 15H22v2h3.95A10.017 10.017 0 0 1 17 25.95Z\"></path></svg>"];
...
const _tmpl$$3 = ["<svg", " xmlns=\"http://www.w3.org/2000/svg\" width=\"1em\" height=\"1em\" viewBox=\"0 0 16 16\"><path fill=\"currentColor\" d=\"M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z\"></path></svg>"];
...
const _tmpl$$2 = ["<span", " class=\"sys-edit-btn p-1 rd-50%\"> <!--#-->", "<!--/--> </span>"],
  _tmpl$2$2 = ["<div", "><div class=\"fi gap-1 op-50 dark:op-60\"><!--#-->", "<!--/--><span>System Role: </span></div><div class=\"mt-1\">", "</div></div>"],
  _tmpl$3$2 = ["<span", " class=\"sys-edit-btn\"><!--#-->", "<!--/--><span>Tambah System Role</span></span>"],
  _tmpl$4 = ["<div", "><div class=\"fi gap-1 op-50 dark:op-60\"><!--#-->", "<!--/--><span>System Role:</span></div><p class=\"my-2 leading-normal text-sm op-50 dark:op-60\">Instruksikan asisten dan atur perilaku asisten.</p><div><textarea placeholder=\"Anda adalah asisten yang membantu, jawab sesingkat mungkin....\" autocomplete=\"off\" autofocus rows=\"3\" gen-textarea></textarea></div><button gen-slate-btn>Set</button></div>"],
...
const _arrow_function$2 = props => {
  return ssr(_tmpl$5, ssrHydrationKey(), escape(createComponent(Show, {
      ...
      return [createComponent(Show, {
        ...
        get children() {
          return ssr(_tmpl$2$2, ssrHydrationKey(), escape(createComponent(Show, {
            ...
            get fallback() {
              return createComponent(_arrow_function$4, {});
            },
            get children() {
              return ssr(_tmpl$$2, ssrHydrationKey(), escape(createComponent(_arrow_function$3, {})));
            }
          })), escape(props.currentSystemRoleSettings()));
        }
        ...
        get children() {
          return ssr(_tmpl$3$2, ssrHydrationKey(), escape(createComponent(_arrow_function$4, {})));
        }
      })];
    }
    ...
    get children() {
      return ssr(_tmpl$4, ssrHydrationKey(), escape(createComponent(_arrow_function$4, {})));
    }
  })));
};
...
const _tmpl$$1 = ["<div", " class=\"my-4 px-4 py-3 border border-red/50 bg-red/10\"><!--#-->", "<!--/--><div class=\"text-red op-70 text-sm\">", "</div><!--#-->", "<!--/--></div>"],
  ...
  _tmpl$3$1 = ["<div", " class=\"fie px-3 mb-2\"><div class=\"gpt-retry-btn border-red/50 text-red\"><!--#-->", "<!--/--><span>Perbarui</span></div></div>"];
const _arrow_function$1 = ({
  data,
  onRetry
}) => {
  return ssr(_tmpl$$1, ssrHydrationKey(), data.code && ssr(_tmpl$2$1, ssrHydrationKey(), escape(data.code)), escape(data.message), onRetry && ssr(_tmpl$3$1, ssrHydrationKey(), escape(createComponent(_arrow_function$6, {}))));
};

__astro_tag_component__(_arrow_function$1, "@astrojs/solid-js");

const _tmpl$ = ["<div", " class=\"", "\"><textarea", " placeholder=\"Tuliskan Sesuatu...\" autocomplete=\"off\" autofocus rows=\"1\" class=\"gen-textarea\"></textarea><button", " gen-slate-btn>Kirim</button><button title=\"Clear\"", " gen-slate-btn>", "</button></div>"],
  _tmpl$2 = ["<div", " my-6><!--#-->", "<!--/--><!--#-->", "<!--/--><!--#-->", "<!--/--><!--#-->", "<!--/--><!--#-->", "<!--/--></div>"],
  _tmpl$3 = ["<div", " class=\"gen-cb-wrapper\"><span>AI sedang berpikir...</span><div class=\"gen-cb-stop\">Stop</div></div>"];
const _arrow_function = () => {
  ...
  return ssr(_tmpl$2, ssrHydrationKey(), escape(createComponent(_arrow_function$2, {
    ...
    children: (message, index) => createComponent(_arrow_function$5, {
      get role() {
        return message().role;
      },
      get message() {
  ...
  })), currentAssistantMessage() && escape(createComponent(_arrow_function$5, {
    role: "assistant",
    ...
    get children() {
      return ssr(_tmpl$, ssrHydrationKey(), `gen-text-wrapper ${systemRoleEditing() ? "op-50" : ""}`, ssrAttribute("disabled", systemRoleEditing(), true), ssrAttribute("disabled", systemRoleEditing(), true), ssrAttribute("disabled", systemRoleEditing(), true), escape(createComponent(_arrow_function$7, {})));
    }
  })));
};
...
}, "C:/Users/mahes/OneDrive - riverz/Desktop/mahesachatgptweb/src/components/BackTop.astro");

const $$Astro$1 = createAstro();
const $$Index = createComponent$1(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$1, $$props, $$slots);
  Astro2.self = $$Index;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "MahesAI ChatGPT" }, { "default": ($$result2) => renderTemplate`${maybeRenderHead($$result2)}<main>
    ${renderComponent($$result2, "Header", $$Header, {})}
    ${renderComponent($$result2, "Generator", _arrow_function, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/mahes/OneDrive - riverz/Desktop/mahesachatgptweb/src/components/Generator", "client:component-export": "default" })}
    ${renderComponent($$result2, "Footer", $$Footer, {})}
    ${renderComponent($$result2, "BackTop", $$BackTop, {})}
  </main>` })}`;
}, "C:/Users/mahes/OneDrive - riverz/Desktop/mahesachatgptweb/src/pages/index.astro");

const $$file$1 = "C:/Users/mahes/OneDrive - riverz/Desktop/mahesachatgptweb/src/pages/index.astro";
const $$url$1 = "";
...
`;
}, "C:/Users/mahes/OneDrive - riverz/Desktop/mahesachatgptweb/src/pages/password.astro");

const $$file = "C:/Users/mahes/OneDrive - riverz/Desktop/mahesachatgptweb/src/pages/password.astro";
const $$url = "/password";
...
const apiKey = "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";
const baseUrl = "https://api.openai.com".trim().replace(/\/$/, "");
